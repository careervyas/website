...
export default function About() {
  return (
    <div className=" w-full h-full flex flex-col relative">
      ...
      <div
        className="flex flex-col items-center justify-center w-full h-full bg-[url('https://firebasestorage.googleapis.com/v0/b/carrervyaswebsite.appspot.com/o/Background%2FBackground%20(1).svg?alt=media&token=8caf9e7c-b9dc-4deb-8efe-487b71ecc568')]
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center justify-center max-w-[1200px]">
          <div className="flex flex-col">
            <img
              className="h-auto md:h-[450px] m-2 md:m-0 CheckIcon"
          ...
          <div className="flex flex-col">
            <img
              className="h-auto md:h-[200px] m-2 md:m-0 CheckIcon"
            ...
            />
            <img
              className="h-auto md:h-[300px] m-2 md:m-0 CheckIcon"
            ...
            />
            <img
              className="h-auto md:h-[400px] m-2 md:m-0 CheckIcon"
