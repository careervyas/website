...
export default function Main() {
  ...
  return (
    ...
    >
      ...
      <div className="flex w-fit h-7 px-2 items-center bg-white rounded-xl font-bold text-xs md:text-lg">
        Building a <span className="text-[#6776FF] px-2">New Era </span>of
        Career Guidance 💪💪
      </div>
      <div className="col-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 w-full gap-4 relative">
        ...
        >
          ...
          <circle
            ...
            strokeWidth="2"
          />
          <circle cx="73" cy="73" r="33.6" stroke="#6776FF" strokeWidth="2" />
          <circle cx="73" cy="73" r="43.2" stroke="#6776FF" strokeWidth="2" />
          <circle
            cx="72.9999"
            cy="73"
            r="52.8"
          ...
          <circle
            ...
            strokeWidth="2"
          />
          <circle cx="73" cy="73" r="72" stroke="#6776FF" strokeWidth="2" />
        </svg>
      ...
      <div className="bg-[#E1E9FF] w-full flex justify-center items-center text-[44px] font-bold py-4">
